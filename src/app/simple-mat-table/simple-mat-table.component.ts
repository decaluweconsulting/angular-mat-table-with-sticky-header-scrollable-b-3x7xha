...
export class SimpleMatTableComponent implements OnInit {
  ...
  dataSource = new MatTableDataSource(this.EmpDataFrom);
  empTos: Employee[] = [...this.EmpDataFrom];
  displayedColumnsFrom: string[] = [
    //'id',
    //'firstname',
    //'lastname',
    //'empFromEmail',
  ...
  displayedColumns: string[] = [
    ...this.displayedColumnsFrom, ...this.empTos.map(obj => '' + obj.id)
  ];
